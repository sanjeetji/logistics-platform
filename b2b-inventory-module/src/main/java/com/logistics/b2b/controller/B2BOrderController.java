...
import com.logistics.b2b.service.B2BSLAMonitoringService;
...
public class B2BOrderController {
    ...
    private final B2BSLAMonitoringService slaMonitoringService;
    ...
    public ResponseEntity<ApiResponse<B2BSLAMonitoringService.SLAReport>> getSLAReport(
            @RequestParam Long clientId,
            @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) LocalDateTime startDate,
            @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) LocalDateTime endDate) {
        B2BSLAMonitoringService.SLAReport report = slaMonitoringService.getSLAReport(clientId, startDate, endDate);
